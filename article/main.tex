...
%and assess the transmission mechanism using the mediation analysis proposed by Imai et al. (2011) and Imai and Yamamoto (2013).\footnote{We use the mediation R package developed by Tingley et al. (2014) for the practical implementation of this framework.}
